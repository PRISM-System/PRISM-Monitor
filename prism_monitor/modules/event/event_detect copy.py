...
def preprocess_table(df: pd.DataFrame):
    # 주어진 테이블의 정합성 검증하고 정상값으로 교체
    # ...
    # return df
    pass
    
def load_data_from_database(prism_core_db, start, end):
    #아래 참고하여 작성
    # datasets = {}
